...
rule convert_biocxml:
	...
	#input: pmc_biocxml_files
	#input: pubmed_biocxml_files
...
#rule pubmed_convert_biocxml:
#	input: FTP.remote("ftp.ncbi.nlm.nih.gov/pubmed/{dir}/pubmed{f}.xml.gz")
#	output: "biocxml/pubmed_{dir}_{f}.bioc.xml"
#	shell: "python convert.py --i <(zcat {input}) --iFormat pubmedxml --o {output} --oFormat biocxml"
